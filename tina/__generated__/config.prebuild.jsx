        ...
        fields: [
          ...
          // --- PRICING PACKAGES ---
          {
            ...
            fields: [
              ...
              { type: "string", name: "idealFor", label: "Ideal f\xFCr" },
          ...
          // --- IMAGE CONCEPTS ---
          {
            ...
            fields: [
              ...
              { type: "string", name: "solution", label: "L\xF6sung", ui: { component: "textarea" } },
              { type: "string", name: "koeniz", label: "K\xF6niz", ui: { component: "textarea" } },
